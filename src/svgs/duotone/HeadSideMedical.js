...
function SvgHeadSideMedical(props) {
  return (
    <svg viewBox="0 0 512 512" {...props}>
      ...
      />
      <path
        d="M320 216a8 8 0 01-8 8h-56v56a8 8 0 01-8 8h-48a8 8 0 01-8-8v-56h-56a8 8 0 01-8-8v-48a8 8 0 018-8h56v-56a8 8 0 018-8h48a8 8 0 018 8v56h56a8 8 0 018 8z"
        className="head-side-medical_svg__fa-primary"
      />
    </svg>
  );
}

export default SvgHeadSideMedical;
