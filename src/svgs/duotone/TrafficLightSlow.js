...
function SvgTrafficLightSlow(props) {
  return (
    <svg viewBox="0 0 384 512" {...props}>
      <path d="M240 240a48 48 0 11-48-48 48 48 0 0148 48z" opacity={0.4} />
      <path
        ...
        className="traffic-light-slow_svg__fa-primary"
      />
    </svg>
  );
}

export default SvgTrafficLightSlow;
