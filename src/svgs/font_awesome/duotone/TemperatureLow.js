...
function SvgTemperatureLow(props) {
  return (
    <svg viewBox="0 0 512 512" {...props}>
      ...
      />
      <path
        d="M416 0a96 96 0 1096 96 96.15 96.15 0 00-96-96zm0 128a32 32 0 1132-32 32 32 0 01-32 32zM160 322.9V304a16 16 0 00-32 0v18.9a48 48 0 1032 0z"
        className="temperature-low_svg__fa-primary"
      />
    </svg>
  );
}
