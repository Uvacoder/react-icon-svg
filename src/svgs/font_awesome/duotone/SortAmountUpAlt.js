...
function SvgSortAmountUpAlt(props) {
  return (
    <svg viewBox="0 0 512 512" {...props}>
      ...
      />
      <path
        d="M16 160h48v304a16 16 0 0016 16h32a16 16 0 0016-16V160h48c14.21 0 21.39-17.24 11.31-27.31l-80-96a16 16 0 00-22.62 0l-80 96C-5.35 142.74 1.78 160 16 160z"
        className="sort-amount-up-alt_svg__fa-primary"
      />
    </svg>
  );
}

export default SvgSortAmountUpAlt;
